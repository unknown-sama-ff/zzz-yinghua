...
export const TEXT_INSTRUCTION =
  '做旧印刷体英文「{NAME_TOP}」和「{NAME_BOTTOM}」分别放置于两个角落，形成对角或同侧配对（左上+左下 或 左上+右下 或 右上+左下 或 右上+右下 四选一），正常比例不拉伸不压缩；文字仅占所在角落区域，约占画面宽20%-30%、高8%-15%，允许与角色局部叠压但不遮挡脸部主体';
